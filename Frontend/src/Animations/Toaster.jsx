  ...
  return (
    <div
      className={` ${show ? "opacity-100 translate-x-0" : "opacity-0 translate-x-10 pointer-events-none"}
        ${type === "success" ? "bg-green-500" : "bg-red-500"} fixed right-4 top-4 z-50 border border-gray-200 rounded-xl w-xs h-15 flex items-center shadow-md transition-all duration-300`}
    >
